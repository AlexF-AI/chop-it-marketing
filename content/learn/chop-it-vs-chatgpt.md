...
The comparison is slightly false, because Chop it runs inside ChatGPT rather than against it. But "should I just use ChatGPT?" is a fair question with a real answer, and the answer depends on which half of the job you mean.
...
| Tick off a list in the supermarket | No | Yes |
